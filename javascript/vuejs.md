...
- 提供一种非常灵活方式来分发 Vue 组件中的可复用功能。一个混入对象可以包含任意组件选项。当组件使用混入对象时，所有混入对象的选项将被“混合”进入该组件本身的选项
...
- [element](https://github.com/ElemeFE/element) A Vue.js 2.0 UI Toolkit for Web <http://element.eleme.io/>
