...
- 个人价值最大化。那么，要选择一个自己能够接触到的、完全竞争的、短流程的渠道，利用算法技术和对业务理解实现变现的过程
- 上级的技术能力:能不能与上级长期相处
- 安排合理的流程:工作流程的管理
...
- 最好的设备
- 标准
  - 在过去，好工作标准：薪水福利好、离家近、不加班、老板为你考虑未来、同事素质高、升职路径清晰
  - 好工作标准这份工作能学到或者强化一些技能，为下一份工作做好准备；要不就是这家公司名声非常好，其他公司很愿意招从这家公司里出去的员工。
  - 不是好工作呢？比如说，在这家公司里，学的东西太过具体，只适合这家公司的这份工作，没有办法将这些技能用到下一份工作当中去，或者是这份工作总得加班，你都没有时间去寻找其他的机会
  - 越来越多公司只对股东/投资人负责，目标降低成本多盈利，不再考虑员工退休养老等问题。想要：有活你就来，短平快完成，干好你就走，别占用太多资源
  - 员工与公司，不再是依附生存关系，而是合作共生、相互选择关系。看清楚变化员工，反过来也就不会去期待公司对他们未来负责，在接受一份新工作时候，就在为下一份工作做准备，这就叫跳槽经济（quitting economy）。好工作标准就是它能否帮助找到下一份工作
- 现代富人依靠资本和人力攫取财富，现在穷人没有资本只有人力，其实穷变富，简单的都在掠夺的资源是人力，及至到了个人，能力是否一直在提升？这或许是解决的唯一途径
...
- 大多数程序员在新公司开始工作约 6-8 个月后，才能完全发挥自己的能力。等到在同一家公司工作2年到3年后，绝大多数人开始停滞不前，对工作不再那么有兴趣。
...
- 遇见问题更高维度去看分析
- 工作有一个前提，事情一定要非常有意思，会内在产生兴奋，可以接受累一点。但最重要的是工作内容
- 35岁 是被环境决定未来的决定时间段
- 失业难以避免，重构人生规划
  - 时代变了，稳定工作越来越少，失业会是家常便饭，人生已经没法依附在某一份具体工作上
  - 对人生预设应该是一生中会多次改变工作，服务过多家公司，干过各种事情，中间很可能有失业期
...
- 参加多样考试
  - 参加各种各样考试，忙忙碌碌，只是为了掩盖人生找不到目标
    - 如果真的知道自己想要什么，就不会花钱找一个地方，只为了坐下来背书
    - 许多人对自己应该做什么，毫无想法，迷茫困惑，不知道怎么才能改变现状，但是又觉得必须做一些事，所以才选择参加考试，然后安慰自己没有浪费时间
  - 考试根本不是出路
    - 如果不知道人生怎么办，就算考过了依然不知道
    - 很多证书对于求职根本没用，在企业的眼里，资历是靠经历和项目证明的，不是靠证书。
    - 退一步说，如果某张证书确实有用，也会因为成千上万的人去考，而很快贬值
    - 建议 不要去参加考试，而要努力寻找那些有兴趣去做、并且能够为此获得收入的事情

### 个人护城河

- 个人护城河是一组独特且不断累积的竞争优势，别人很难学习，或者很难做到。如果有了它会让自己变得无法取代
- 必须找到属于你的特殊东西，而且这些东西会随着时间的流逝而增加价值
- 如何找到自己的护城河？
  - 可以问自己：对我来说，什么事情容易做，而对别人却很难？
  - 所拥有的技能中，哪些是其他人模仿会非常困难的？
  - 或者，所爱的、擅长事物，跟社会需要的事物有什么交汇点？
...
- 写简历的时候，千万不要把自己懂的所有技术都写进去，那是简历的扣分项。而只写你掌握最深的那项技术，以及与之相关的工作经历。
- 万一你选择的技术栈走下坡路（比如 PHP），甚至消失了（比如 Flash），你可能被迫要换技术栈，那就惨了。最保险的做法，就是选择那些有大公司支持的技术。这就是为什么市场上有那么多 Java 专家和 .Net 专家的原因。
...
- 对于时间紧任务重求职者不要胡子眉毛一把抓，抓几个重点问题好好理解一下就可以
- 一定要准备项目描述里提到技术
  - 结合项目背景
  - 有不少关键点，用到以后一定是知道的
  - 可以准备些这个技术的高级问题
  - 一定得准备亮点话题，并想办法往这方面绕，而且亮点话题多多益善
- 项目描述要点 业务需求可以一笔带过，用寥寥几句话介绍项目背景，大致做了什么，工期和人数即可，别讲太多，因为面试官不关心
  - 结合项目实际需求，介绍项目用到的技术
...
- 关注
  - 基础技术基本功是不是扎实
    - 吃透底层原理，夯实基本功，基本决定一个程序员是否有全局观、能否走得长远
  - 对实际问题有没有深入分析和处理能力
  - 跟同事/领导/业务部门等合作方沟通能力
  - 对自己清晰认识和明确发展定位
  - 对各种新鲜事物保持好奇心和探索精神
- 技术圈是一个转速非常快群体
  - 从大学毕业到 30 岁是一个黄金时期，需要积蓄足够力量
  - 在 30 岁左右爆发，否则 35 岁以后，人生的分水岭出现
  - 有的人选择退出一线，走上管理岗位
  - 一部分人开始走下坡路。当然，不排除有些人大器晚成，但是所有后来居上的人都是在早年做了充足的准备
  - 正是由于技术人的黄金时间有限，因此大家都希望抓住技术风口
- 新人进入软件行业，应该学什么
  - 不要让自己太忙碌。雇用新毕业工程师时会派给很多琐碎工作使他们饱和。会逐渐忘记大学里学到的课程，全部注意力都集中在手头的工作。很多人倾向于通过忙碌程度来评价自己，相信这是一个死亡陷阱。"

### 大厂

- 聪明、反应快，意味着学习能力、适应力强，能够快速胜任工作
- 算法不错，代码基本功好，这点其实考察的是算法能力和代码是否写得优雅
- 基础过硬，技术岗面试最核心还是考察技术储备，包括语言基本功，操作系统、网络、体系结构、系统设计
- 语言组织和表达能力 用简洁准确的语言表述出来
...
- 需要大致知道这个世界的一些规律和发展趋势，
  - 技术的演进规律基本是自动化加规模化，从而降低成本，提升效率
  - 技工-》特种工-》工程师-》设计师与架构-》经理

- 认识自己
  - 自己到底适合做什么？在这个趋势和规律下属于自己的发挥领域到底是什么？这是我们每个人都需要了解的。
  ...
  - 兴趣。如果没有找到自己特长，就找自己有兴趣有热情东西。什么叫兴趣？兴趣是再难再累都不会放弃的事。如果你遇到困难就会放弃不叫兴趣，那叫叶公好龙。不怕困难，痴迷其中，就算你没有特长，有了这种特质，你也是头部的人才。
...
- 提升成长效率，因为现在社会的节奏实在太快了，比二十年前快得太多，技术层出不穷，所以我们的成长也要更有效率。效率并不单指的快，效率是怎么样更有效，是有用功除以总功，怎么学到更有效的东西，或者怎么更有效学习，是我们需要掌握的另一关键
...
- 26岁啊！我们公司测试部门的一个架构师26岁时还在四川乡下当义工。Doug Schimit26岁时还在攻读社会学，Dennis Ritche26岁时刚加入Bell实验室开始搞计算机, BEA中国区的Principle Engineer26岁时还在读化学。现在中国IT业功成名就的很多老人们26岁时还在战天斗地。
...
- 基础
  - 一颗责无旁贷的责任心：一旦接受了某项任务，就应该为之负起全部的责任，想方设法也要尽自己最大的努力去完成它，凭一己之力也好，寻求他人帮助也罢，这都可以，但须始终牢记：最终承担责任并推动任务前进的，绝对只能是你自己；
  - 应该要明白，千里之堤毁于蚁穴。对软件中存在的“破窗户”始终要坚持零容忍，因为一旦有“破窗户”出现，那么软件项目的失控速度绝对远远超出你的预期，等你缓过神来，一切已为时已晚，弥补代价甚至超过整个推倒重来的代价
  - 需要是一个完美主义者，始终处于追求完美的途中，但同时你要深深的明白，你永远也无法到达完美的彼岸，因为这个世界上不存在完美的软件，现在没有，你也不大可能会创造出第一个，所以需要你在适当的时候为你的软件画上休止符。
  - 成功与失败的区别在于，成功者选择了正确而失败者选择了错误。因此，我们常常能够看到一些天赋相差无几的人，由于选择了不同的方向，人生却迥然相异。
  - 选择正确的方向尤为重要。软件开发也是有层次区别的，比如，按层次从高到低通常可分为
...
- 架构师：在扎实的技术基础上(高级软件工程师)，如果有着比较强的抽象设计能力，又打算专注于技术开发
- 技术型管理：如果性格更适合做管理，情商能力突出。决胜点在于长期的点滴积累，无论程序员个体之间差异有多大，程序员上升空间在于技术上的反思和提高。
- 软件设计师：程序员在编程序的时候，一方面会实现设计的功能，另一方面也在对设计有一个理解、认识、熟知的过程。进而慢慢地从学习别人设计，转向到自己参与或独立设计。如果这个程序员真的非常非常喜欢程序员这个职业。
  - 这个转变很大程度是程序员意识的转变，就是说要把编程的时间，逐步分摊到软件设计上，要把重点从编程实现转变到项目的功能设计上。
  - 这里强调的是“逐步”的一个过程，程序员要逐步减少编程的时间，增加设计的时间，要克服编程的强大吸引力，要主动地攀上设计这个台阶。
  - 很难有一个设计师是完全不编程的，而且我认为，会编程的设计师才是真正的设计师。一般这种转变需要花上一到两年时间。
  - 软件设计中最重要的基本原则，其实也不仅仅是软件设计，很多地方也都是适用的：
    - 坚决避免重复
      - 俗话说得好——唯一不变的就是变化本身！如何选择适当的粒度，如何进行适当的模块划分，从而把变化能够封装在一个尽可能窄的范围内，以便某个变化只会造成局部的影响，而整个软件框架能够尽可能的保持稳定不变，不会牵一发而动全身，这才是软件设计最精彩的地方，也是软件设计能从工程问题变为艺术问题的机会。
      - 需要不停的通过不断迭代的软件版本与用户进行交流沟通，挖掘出用户真正的需求并及时进行修正，必要时还需要对整个软件进行重构，这样经过几次迭代后，才有希望得到一个满足用户需求的接近完美设计。
      - 最后一点——需要具有在代码中签名的勇气，这个签名就像是一个品牌标识，是代码质量的保证，表明这段代码是你引以为傲的作品。
    - 高内聚低耦合的设计
- 项目经理：也有一些程序员工作机遇比较好，不但负责了项目的设计工作，而且负责了项目管理工作。对项目经理这个工作有了一定的尝试。因此，这类程序员可以审视一下自己，是否合适这项工作。如果自己对这种工作比较满意，而且具备项目经理的要求，则可以向项目经理这个方向发展。
  - 项目经理承担着项目管理的职责，对项目负主要责任。它和程序员的作用也不相同，项目经理的重点已经从编程转移到对人、对技术、对进度、对项目的管理。
  - 由于软件的项目经理与软件项目的相关性太大，因此，他必须要了解软件开发的各个环节、了解开发的各种技术和运用、了解开发队伍人员的水平和特点。所以他依旧和程序员脱不了干系。
  - 从程序员到项目经理可以使得项目经理更好地理解程序员在项目中的地位和作用，了解软件开发的各种规律性的东西。从而保证项目的正常完成。而且，项目经理的收入在公司中的地位也是比较高的。程序员在担任项目经理之前最好要把软件设计工作做好，这样在做项目经理的时 候，就会有很好的基础。
- 进阶瞬间
...
- 走一条不一样的路：在有利于自己的市场中竞争，如果你满足于"泯然众人矣"，那恐怕就得跟那些低工资国家的程序员们同场竞技了。
- 了解自己的公司：以我在医院、咨询公司、物流企业以及大技术公司工作的经验来看，这一点所言不虚。不同公司的运营模式差异极大。如果你理解企业的运营模式，那你就不一样了！在这家公司中（或者对客户而言），你是参与业务运营的资产，你的工作能直接产生效益！
- 与最优秀的人为伍：很早以前，我喜欢打篮球，被分配到一个水平比较高的队里。一开始适应的确很困难，但环境的压力越大（重大比赛），我的长进也就越明显。每个领域其实都一样：你周围人的水平（以及对你的期望）越高，你就会变得越优秀。
- 制造差异：每年学习一门新编程语言。为什么不呢？不断尝试新事物，你关注的技术种类越多，脚下的路就越宽广，你的职业生涯就会日新月异。不知道几年后Java的趋势如何？那就学习Clojure。学Ruby还是Python？这两种语言都可以试试啊。然后你才能知道哪种语言更适合某个特定的项目。看，掌握的语言多了，才能在需要的时候信手拈来吧。
- 畏惧，是最大的敌人：还是直接从书中摘一句吧："在畏惧中做出的职业规划，很可能会让自己后半辈子就一直被'圈禁'在小隔断里，永远不会有创造明天辉煌的时刻。没错，那样是安全，但有意思吗？"
- 要成为多面手：如果你掌握了所在领域的知识，那你只能是一名专业人士。用PHP编程？花点时间设置一台Apache服务器，让PHP和MySQL都跑起来。一直在用jQuery？试试Prototype。你懂了吧。
- 一个字：做 别指望别人过来教你该怎么做，出去，自己学着去做！
- 找一位好老师：找一位好老师可以让你在学习技术的时候有的放矢。作者给我们讲述了别人是怎么指导他学习的（顺便说一句，作者在这本书里讲了很多个人经历的小故事，他居然从一位演奏家转行来做软件开发！）："好好研究一下目录服务，熟悉一种UNIX变体，然后再掌握一门脚本语言。"请记住这句禅宗谚语："循路觅宗师，形影不相离，师知吾亦知，吾乃成宗师。"
- 主动教会别人：教会别人是一种最好的学习方式。写一篇博客能帮你搞清楚一个问题。为此，你必须先掌握很多材料，同时还要有条有理地讲给别人听（写作技能）。如书中所言："要想知道自己是不是真的明白，你就讲给别人听听。"
- 实践，实践，再实践（训练）：只有进行大量实践（花大量的时间）才能掌握某种技术。看的很多，写的很少，遇到问题，改一改，又去读代码......（这样下去是不行的）。要特别警惕拖延症。其实，往往只要有了开头就好办了。自我加压，效果会更好。我曾在一篇博客中提到帕金森定律：紧张的时限可以让你提高工作效率。为什么不把这个定律用到学习上呢，比如说在y时间内学会x？
- 从小处入手：每天都取得一项小成果，每天都要坚持做（写在博客上？）。这样一来，你只能让自己比昨天更进步，而不能说自己比上星期进步了一点。
- 享受过程：关注当下，而不是目标，享受那些在追逐未来目标的途中可能无暇顾及的小胜利。人总要生活在当下。我享受编程的过程，就像享受编程的结果一样。
- 不要丧失危机感：越是成功，就越容易犯重大错误。永远不要忘了危机感，特别是要认识到你今天所知道的，到了明天可能就会一文不值。过去的荣耀不能保你永远无虞。据书中所说，你最好是要让自己能够"通用"，而不要对哪种技术或哪个公司产生依赖。你所掌握的某些技能，甚至你的工作，到了明天都可能会变得毫无价值。因此要不断提高/丰富/扩展自己的技能。
- 推销自己：为某个项目贡献自己的一份力量，写一篇博客，共享自己的源代码，成为对某个社区有用的人。当然，做这些事可能需要激情，要看你的爱好，但这些事也会间接地推广你的工作成果，证明你的实力，提高你的知名度。
- 关注市场：书中还提到了"预警极客"，也就是那些始终引领技术发展的人。这些人说过的话往往带有预见性，他们提到事物也许过几天就会成为头条新闻。关注这些人，常看他们的Twitter和博客。"每个人都觉得这里遍地都是黄金。没有人在讲述大部分人经历的故事，这些人可以什么都做对了，非常卖命的工作，但半年之后还是不得不离开这座城市，他们可能破产了可能自信心受到了严重的打击，梦想也破碎了。"
...
- 负责任:给指派的任务，要保质保量认真按时完成
- 技术过硬:对技术在实际业务模型下的应用能力，自己在实际工作中对问题的分析解决能力
- 沟通能力
  - 讲述一件事情或者描述一个物体要有条理，有逻辑，能用清楚明白语言把要描述对象描述出来
  - 抽象和归纳：要把技术概念抽象出来，并且概括提炼要说内容组织语言表达出来，让对方快速理解要表达东西
  - 要学会跟上级即时沟通状态
    - 那种需要相对长期时间完成任务，尽量在一些关键的点汇报自己情况，让对方知道自己在做什么，做到哪里，还有什么剩下的，有没有什么问题，有没有风险，需不需要帮助等等
...
- 可以不喜欢，尽可能别浪费。毕竟对于刚毕业时候的你，除了你的专业，拿什么跟别人竞争？如果专业内卷严重，可以跨专业，但不能丢专业，一定是叠加关系，不是弃暗投明关系。只有叠加才对得起“变老”。重新来过，半路出家，很容易后浪推前浪，死在沙滩上。如果本身自学力差，那专业——很可能是你一生里唯一的敲门砖。重头来过还能保持战斗力，也许你需要创造不老的神话。
...
- 方向
  - 供配电
  - 发输变电
- 均需要通过基础考试+专业考试才能取得执业证书
  - 均为选择题
  - 公共基础在上午进行，上午8:00-12:00，共四个小时
    - 120题，每题1分
  - 专业基础在下午进行，下午2:00-18:00，共四个小时。考试内容涵盖如下：
    - 电路与电磁场、模拟电子技术、数字电子技术、电气工程基础（电力系统基本知识、电力系统分析、变压器、电机学、主接线和电气设备选择等）
    - 60题，每题2分
  - 只要合计超过132分，则视为合格，可取得合格证书，且终身有效
- 报名 每年的七月底八月初 [网上报名](https://www.cpta.com.cn/)
- 备考
  - 《公共基础知识复习教程》
  - 《公共基础历年真题解析》
  - 《注册电气工程师专业基础 考点剖析与真题解析》。
...
- 在固定环境里长期待下去的弊端 就是会造成社交范围的固化
- 如果会陆续换工作 换环境 那么同时也会遇到各种各样的人 当然其中有合得来的人就肯定也有合不来的 但总之只要是肯换 就是有一个拓展交际的机会在的 而交际直接影响了人的视野进而影响思维。倒不是说要攀附着别人 把自己变得多么厉害 而是对各种生活形态的一个多样化了解 不局限自己的认知 
- 有时候会和一些生活比较稳定的朋友聊天 就发现他们总是在纠结同样的人 相似的事 而且会翻来覆去地找我吐槽 又不真的做出实质性改变 我就只能勉为其难地倾听…后来我发现 其实就是因为他们环境固化…已经结识了新的朋友 有些压力我会分不同方向去释放 但他们没办法 他们身边的人没有机会流动 只能抓着好不容易说得通的老朋友…
- 由此又想得远一点 就是不论到什么时候 不论财富是否自由 不论处于什么样的亲密关系 总之一定要有自己的生活 自己的工作 自己的社交 道理是相通的
...
- 时间、金钱、发自内心的渴望，过硬的技能，健康的身体再加上一个和睦可托底的家庭关系，大概就是一个自由职业者能够保证高效和持续不断输出的必备条件了吧
...
- 刚开始工作头几年，上司指出我做错的，我都会说很多自我检讨。现在我要么不回应，要么当不知道装傻，要么一句shit happens。。。这也许就是职场老油条吧。。
...
- 认为创业最大的动力来源可能是好奇心。虽然好奇心并不意味着他们已经有了答案，但是他们都非常想能够找到方案。
- 害怕迟疑还不如一步一个脚印实践起来
  - 一定要理解你的消费者和他们为什么要与你的产品产生链接，这是最为重要的。
  - 无论你创业是提供一种服务还是一种实体的产品，规模化你的生意的关键因素是了解你的客户
  - 规模化你的生意的关键因素是了解你的客户，要确切地知道他们的需求是什么。什么使他们买单
  - 最好的创业者一定是不断观察客户的人
  - 作为创业者，自己也经常花费时间在超市与顾客或者店主进行交流，或者阅读顾客的服务邮件。这让她能够充分地从顾客的角度来看待问题。
- -从错误中学习经验
  - Goldin在文章中还说到，创业过程中遇到的一个非常大的挫折是2010年，Hint在当年有幸与星巴克建立了全国的合作关系。Hint被摆在了全美的7000多家星巴克中进行销售。在之后的十八个月中，hint的销售业绩发生了质的飞跃，达到了他们销售目标的三倍，但是很可惜这个合作关系也在仅仅十八个月后就终结了。在随后两周内，他们盈利的4成就这样没了。他们等于是一时天堂，一时又被打入了地狱。后来总结说，他们当时最大的问题就是只把精力专注于了如何维持好与星巴克的合作关系是否能够一切稳定运行，但是他们没有匀出其他的精力去拓展星巴克之外的商业合作。
- 大多数都忽视了这个问题，他们创业的早期或多或少都在思考，如何将自己的才华，技能，点子或者资源用到更好，使得生意变得有起色，但是他们往往都忽视了这个非常重要的因素，你的客户在哪里？你能提供给客户什么硬需求的满足？一旦开始创业就不再是做学术，搞艺术，可以曲高和寡。
- 创业讲到底是应该紧紧盯住客户的需求，才能存活下去。而笔者觉得这篇文章好的地方，就是Goldin直接点破了此天机，所以一定要推荐给大家。而且这并不是仅仅推荐给想要创业的人，而是推荐给每个朋友，因为每个人的人生其实就是自我打造自我的生意。

### 自主创业(self-employment)的评估

- 《Self-Employment: Building an Internet Business of One》Frank Kane
- 我有一个成功的职业履历，因为我总是能按时交付成果。（交付信誉记录）
- 在我独立工作、没有团队支持我的情况下，我的生产率反而更高。（独立工作）
- 我能够在较短时间内，通过自学快速掌握一门新技术。（快速学习）
- 对于项目，我会慎重选择投入。对于选定的项目，我不会半途而废或虎头蛇尾，我总是能坚持和有始有终的完成项目。我深知未完成的项目、没有交付给用户实际使用的项目是没有价值的。（慎始慎终）
- 对于任何联络我的人，我总是能耐心回复。我一般不会忽略邮件或电话。（客服意识）
- 我能高效地管理时间，几乎不会感觉忙乱。（时间/项目管理）
- 工作时我能聚焦于手头的任务，也能排除各种干扰。（生产效率）
- 之前的同事大多反馈说我具有良好的沟通技能。（沟通能力）
- 在我的人脉网络中，我至少有100个专业朋友联系人。（人脉资源）
- 即便没有老板监督，我也能自律和努力地工作。（自律性）
