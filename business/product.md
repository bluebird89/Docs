...
- 想法落地过程是通过业务和技术部门的互动协作、结合产品策略、体验设计、技术架构、交付计划的敏捷软件交付项目启动实践
...
- 研发体系
	- 需求评审
		- 需求一定要看客户背后意图
		- 鼓励提供两个以上方案，然后进入“左右互搏”模式
	- 代码合入
		- CR 一级：模块的维护者来 review，目的是让模块的稳定性能够得到保障。毕竟在别人家的田间地头自己的庄稼，总不能背着这块地的主人搞小动作不是
		- CR 二级：自己 leader 来 review，这是整个 CR 的核心基石。很幸运团队有像 taopu 一样负责和认真的 leader，会非常细致的 review 大家的每一行代码，并积极提出意见和建议，在 CR 中提升大家的技术水平
		- CR 三级：总监负责 review 和 代码合入，更多是抽检，看看哪些同事是真正地爱这款产品，哪些同事则是不那么负责的架构破坏者
	- 功能测试
- 产品体系
	- 通过场景落地来验证产品质量
	- 通过数据体系来评估产品质量
	- 经验
		- 不同客户关注点是不一样：比如教育客户关注稳定性，电商直播关注清晰度，秀场直播关注音质。如果给一个在线教育客户去过度地优化画质，客户不仅可能不买账，还可能因为优化影响了其他指标而弃用产品
		- 音视频表现不是简单地靠 DAU、成功率来衡量的。比如“切课率”这个指标，影响因素非常多，比如网络波动呀，硬件发热呀，麦克风阻抗大呀，显卡驱动不匹配呀，还有可能是用户心情不好砸键盘呀。就说有个客户，发现上课声音效果不好，结果客户很负责，亲自到了学生家去确认，最后发现是 iPad 的保护套把麦克风给遮住了
- 数据体系
- 排障体系
	- 分析过去两周内任何一个用户的任何一次体验问题，并能够定位到技术层面的缺陷或者环境方面的问题
	- 在线日志和离线日志系统的双重保障，也让排障的信息变得更加容易获取。以往比较困难的线上死锁问题和调用时序问题，也开始不再那么可怕和束手无措
...
- 抖音的推荐算法有一个最大的优势，就是它的内容很短，用户的观看历史以秒计算。用户使用一个小时，可以产生几百条观看记录。
- Netflix 需要等待一个月，才能获得相同数量的用户观看记录。
...
- 一头烧钱买流量生源，一头知识付费赚现金流。先在微信公号、抖音、今日头条等平台投放广告，以0元、9元等低价引流课吸引用户报名。用户报名后会进入专门的微信群学习，班导、督学作为服务+销售人员，会引导用户购买后续的高价网课（1000~3000元），像语数英等主干课的培训费，客单价甚至高达万元。
- 由于业务路径非常短平快，想要提升营收，就要多砸钱投放，多营销，刺激用户续课，同时用AI、直播、社群工具来提升运营效率、降低成本。因此，业务的扩张和模式的创新势在必行。扩张也带来了大量的工作岗位，在线教育行业为刚毕业一两年的大学生，特别是基础学科的文科毕业生，提供了海量职位和高于平均的薪资水平。
- 2021年6月，教育部颁发双减政策（义务教育阶段的周末和节假日，寒暑假的1-9年级学科补习全部禁止，高中保留），这对幼儿到初中阶段的在线教育业务造成了极大的影响。同时相关部门也加强对招生广告投放的监管，没有相关专业牌照、资质的机构，不能随便进行诱导性广告投放，这进一步打击了K12以外的成人教育行业。
- 行业见闻
  - 20年太疯狂了，疫情又给行业烧了一把火，到处都能看到广告。有一些老师为了追求高业绩，利用家长的焦虑心态，诱导报课，我认为这背离了教育的初心。教育这个东西没有那么容易出成果，需要一步步慢慢来，但相信教培的需求是一直存在。
...
![Alt text](../_static/product_design_method.jpg "Optional title")
