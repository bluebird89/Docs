...
- 莱茵金属BAE系统陆地分部首次展出了安装以色列拉斐尔先进防务系统公司奖杯主动防御系统的挑战者3（图1），在此之前以色列的梅卡瓦4（图2）、德国的豹2A7A1（图3）、美国的M1A2系统增强包3型（图4）
...
- 利用大型航空母舰与小型直升机母舰组成高－低搭配组合参战，负责低层作战的就是制海舰和垂直／短距起降舰，成本低廉，装备用于摧毁敌方潜艇部队的反潜直升机以及用于截击苏联远程飞机的垂直起降战斗机和预警直升机
- 由于为制海舰开发的洛克韦尔XFV－12超音速垂直起降战斗机达不到设计要求，整个项目成本超支，加之后来苏联解体，制海舰项目也被放弃。
- 随着F－35B闪电II的成功，美国海军的黄蜂级和美国级两栖攻击舰、英国海军的伊丽莎白女王级航空母舰、日本的出云级直升机母舰、意大利的加富尔级航空母舰、第里雅斯特级两栖攻击舰、澳大利亚的堪培拉级两栖攻击舰等类似战舰都可以携载F－35B进行制海作战。
...
- 第四代半
  ...
  - 俄罗斯基于[苏27](https://zh.wikipedia.org/wiki/%E8%8B%8F27 "苏27")升级版
...
- 第五代战机
  - 在科技上与前一代最大的差异 低可侦测性技术运用
	  - 在1970年代美国采用几十年积累下来的研究成果，配合电脑的高速计算能力，逐渐将降低雷达截面积（RCS）的估算成功的几率与飞机设计融合，为了满足低可被侦测性而不再使用外挂点,可携带弹药因而大幅减少
  - F-22
  - F-35
	  - F－35B
  - T-50
