...
* 接口命名
  ...
  - 命名必须规范、优雅
  - 单一性:接口要做的事情应该是一个比较单一的事情，比如登陆接口，登陆完成应该只是返回登陆成功以后一些用户信息即可，但很多人为了减少接口交互，返回一大堆额外的数据
* 客户端能处理的逻辑就不要给服务端处理，减少服务端压力
* 请求参数
* 可扩展:设计接口的时候多想想多种情况，多考虑各个方面
  - 接口充分考虑客户端，想想他们是如何调用的，要怎样使用我的代码，会如何扩展我的代码，不要把过多的工作写在你的接口里面，而应该把更多的主动权交给客户程序员
* 必须有文档
* 支持的协议
* TPS、并发数、响应时长
* 数据存储。DB选型、缓存选型
...
* [public-api-lists](https://github.com/public-api-lists/public-api-lists) A collective list of free APIs for use in software and web development rocket https://public-api-lists.github.io/public-api-lists/
