...
- [MIT公开课：数据分析、信号处理和机器学习中的矩阵方法 Matrix Methods in Data Analysis, Signal Processing, and Machine Learning](https://ocw.mit.edu/courses/mathematics/18-065-matrix-methods-in-data-analysis-signal-processing-and-machine-learning-spring-2018/)Gilbert Strang
...
### MIT 线性代数 MIT Linear Algebra (2000)

- [Linear Algebra 麻省理工公开课：线性代数](https://ocw.mit.edu/courses/mathematics/18-06-linear-algebra-spring-2010/):Introduction to Linear Algebra (3rd Ed.) by Gilbert Strang 
	- <http://open.163.com/special/opencourse/daishu.html>
- [math](https://github.com/apachecn/math):MIT-18.06-线性代数-完整笔记
