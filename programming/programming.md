...
- 永远不要复制和粘贴不是自己编写的代码。如果一定要复制，那就照着它逐字输入，逼着自己思考，这些代码实际上是什么意思。
- 996 工作制不适用于科技公司 程序员在一段代码上花费更多时间，并不意味着写出更好的代码。事实上，处理错误的最佳方法通常是休息一下，然后回来重新阅读代码，你会更容易发现错误。
...
了解技术就一定需要了解整个计算机的技术历史发展和进化路线。因为，要朝着球运动的轨迹去，而不是朝着球的位置去，要知道球的运动轨迹，你就需要知道它历史上是怎么跑的。
...
- 如果一定需要通过观看“视频”课程才能学会编程的话，劝你还是及早放弃这个没有前途的行业吧.图文教程足够了，不需要视频，视频是效率最差的学习方式，信息熵太低了
